...
class Grupo(models.Model):
    ...
    grupo_letra = models.CharField(max_length=10)  # Ej: "1", "2", "TOL-II"
...
class Alumno(models.Model):
    ...
    # NUEVO: antes el CURP solo se usaba como texto de la contraseña al crear
    # el usuario, pero nunca se guardaba como dato del alumno — por eso la
    # columna "CURP" del panel siempre salía vacía. Ahora sí se persiste.
